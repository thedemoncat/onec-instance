...
docker build -t ghcr.io/thedemoncat/onec-server:$ONEC_VERSION --build-arg ONEC_VERSION=$ONEC_VERSION ./onec-server
rm -rf ./onec-server/distrib/

# onec-server-ws
docker build -t ghcr.io/thedemoncat/onec-server-ws:8.3.21.1302 --build-arg ONEC_VERSION=$ONEC_VERSION ./onec-server-ws
